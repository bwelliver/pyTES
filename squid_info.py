...
class SQUIDParameters:
    ...
    def get_squid_parameters(self, serial):
        ...
        if serial == 'S0121':
            ...
            self.Li = 6e-9
            self.Mi = 1/26.062
            self.Mfb = 1/33.22789743 #1/33.33730134 #1/33.16710559014 #1/33.33730134  #1/33.51162 #1/33.96774594  # 1/33.5132196
            self.Rfb = 10000.0
            self.Rsh = 21.0e-3
            self.Rbias = 10000.0
            self.Cbias = 100e-12
            ...
            self.Li = 6e-9
            self.Mi = 1.0/25.135
            self.Mfb = 1.0/32.9  #1.0/33.88  #1.0/33.6  #1.0/33.00684710478  #1/33.6504 #1/33.22789743 #1/33.32 #1/33.8403378  #1/32.62  #1/33.343662  #1/33.88826885424  #1/33.21197780928  #1/33.343662 #1/33.08377 #1/33.21197780928  #1/33.08377 #1/33.343662 #1/(33.5028)
            self.Rfb = 10000
            self.Rsh = 20.2e-3
            self.Rbias = 10000.0
            self.Cbias = 100e-12
