...
class SQUIDParameters:
    ...
    def get_squid_parameters(self, serial):
        ...
        if serial == 'S0121':
            ...
            self.Li = 6e-9
            self.Mi = 1/25.135
            self.Mfb = 1/33.32 #1/33.8403378  #1/32.62  #1/33.343662  #1/33.88826885424  #1/33.21197780928  #1/33.343662 #1/33.08377 #1/33.21197780928  #1/33.08377 #1/33.343662 #1/(33.5028)
            self.Rfb = 10000
            self.Rsh = 20.2e-3
            self.Rbias = 10000.0
            self.Cbias = 100e-12
